...
class ViewSlot extends GetView<CabinetController> {
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: TypeAheadField(
                    textFieldConfiguration: TextFieldConfiguration(
                      ...
                      controller: TextEditingController(text: controller.cabinetPillsList[controller.itemSelected].pillName),
                      enabled: false,
                ...
                Container(
                  margin: EdgeInsets.only(right: 12.w, bottom: 3.h),
                  child: DropdownButtonFormField(
                    ...
                    value: controller.cabinetPillsList[controller.itemSelected].dosage,
                    decoration: InputDecoration(
                      fillColor: Theme.of(context).colorScheme.primary,
                      focusColor: Theme.of(context).colorScheme.primary,
                      filled: true,
                ...
                Container(
                  ...
                  child: DropdownButtonFormField(
                    value: 'Slot ${controller.cabinetPillsList[controller.itemSelected].slot}',
                    dropdownColor: Theme.of(context).colorScheme.primary,
                    focusColor: Theme.of(context).colorScheme.primary,
                    style: TextStyle(
                      fontFamily: 'Sansation',
                ...
                Container(
                  ...
                  child: DropdownButtonFormField(
                    value: controller.cabinetPillsList[controller.itemSelected].interval,
                    dropdownColor: Theme.of(context).colorScheme.primary,
                    focusColor: Theme.of(context).colorScheme.primary,
                    style: TextStyle(
                      fontFamily: 'Sansation',
