            ...
            if(controller.pillQuantity.text.isEmpty){
              ...
              if(controller.slot.value == 6){
                ...
                if(controller.durationDates.isNotEmpty){
                  ...
                  Get.snackbar(
                    "Pills Reminder",
                    "Please select the dates for medicine",
                    icon: const Icon(
                      Icons.crisis_alert,
                      color: Colors.black,
                    ),
              ...
              () => Column(
                ...
                children: [
                  DropdownButtonFormField(
                    ...
                    onChanged: (value) {
                      controller.slot.value = int.parse(value!.substring(5,6));
                  ...
                  controller.slot.value != 6 ? Container(
                  ...
                  controller.slot.value != 6 ? CustomTextField(
                    fontWeight: FontWeight.w400,
                    text: "Duration *",
                    color: Colors.black,
                    size: 15.sp,
                  ...
                  controller.slot.value != 6 ? const MedibotDurationPicker() : Container(),
                ],
              ),
            ),
          ),
