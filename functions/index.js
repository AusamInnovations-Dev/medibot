        ...
        if (todayHistory.exists) {
            ...
            if (index == null) {
                ...
                await db.collection("History")
                    ...
                    .doc(docId)
                    .set(history);
                res.send({ "message": "Data Uploaded successfully", "data": history });
            } else {
                var list = [];
                list.push(...history['historyData']);
                ...
                res.send({ "message": "Data Uploaded successfully", "data": list });
            }
        } else {
            let historyModel = {
                "userId": docId,
            ...
            await db.collection("History")
                ...
                .doc(docId)
                .set(historyModel);
            res.send({ "message": "Data Uploaded successfully", "data": historyModel['historyData'] });
        }
    } catch (err) {
        console.log(err.toString());
    }
